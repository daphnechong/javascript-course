describe('Snake', function() {
	...
	describe('move', function() {
		...
		it('should return the last coordinate of the snake as the oldPoint', function() {
			var s = snake('up', [ { x: 2, y: 2 }, { x: 2, y: 3 }]);
		    var moves = s.move(5);
